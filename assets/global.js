...
function changePosition() {
  window.onscroll = function() {
    var mySticky = document.querySelector('.section-image-custom-sticky');
    if(!mySticky) return;
    if (window.pageYOffset >= 1000) { // If the scroll is 1000px or more
      mySticky.style.position = 'relative'; // Hide the div
    } else {
      mySticky.style.position = 'sticky'; // Show the div
    }
  };
}
